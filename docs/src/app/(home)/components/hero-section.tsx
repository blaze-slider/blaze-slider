  ...
  return (
    <header className="relative px-4 pt-32 pb-20">
      <div className="relative mx-auto max-w-4xl text-center">
        <h1 className="text-fd-foreground mb-3 font-serif text-4xl leading-none tracking-tight sm:text-5xl md:mb-6 md:text-7xl">
          High Performance Carousels
          <br />
          <span className="text-fd-foreground">for modern web</span>
        </h1>

        <p className="text-fd-muted-foreground mx-auto mb-5 max-w-lg text-sm leading-relaxed md:mb-10 md:text-lg">

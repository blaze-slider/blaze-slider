  ...
  return (
    <header className="relative px-6 pt-32 pb-20">
      <div className="relative mx-auto max-w-4xl text-center">
        <h1 className="text-fd-foreground mb-6 text-4xl leading-none tracking-tight sm:text-5xl md:text-7xl font-serif">
          High Performance Carousels
          <br />
          <span className="text-fd-foreground">for modern web</span>
        </h1>

        <p className="text-fd-muted-foreground mx-auto mb-10 max-w-lg text-lg leading-relaxed">
